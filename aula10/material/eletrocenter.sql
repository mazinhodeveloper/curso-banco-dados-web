...
--
-- Host: 127.0.0.1
-- Tempo de geração: 21/03/2026 às 15:26
...
-- Funções
--
CREATE DEFINER=`root`@`localhost` FUNCTION `fn_margem_lucro` (`p_custo` DECIMAL(10,2), `p_preco` DECIMAL(10,2)) RETURNS DECIMAL(10,2) DETERMINISTIC BEGIN         
