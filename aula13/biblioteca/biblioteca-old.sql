...
--
-- Host: 127.0.0.1
-- Tempo de geração: 25/04/2026 às 13:07
...
INSERT INTO `cliente` (`id_cliente`, `nome_razao`, `cpf_cnpj`, `email`, `telefone`, `celular`, `cep`, `logradouro`, `numero`, `complemento`, `bairro`, `cidade`, `uf`) VALUES
...
(7, 'Paulo Santos', '555.666.777-88', 'paulo.santos@email.com', '1177889900', '11921098765', '01007-000', 'Rua G', '700', 'Casa 1', 'Ipiranga', 'São Paulo', 'SP'),
...
(20, 'Camila Bastos', '888.000.222-44', 'camila.b@email.com', '1144223355', '11988775544', '04003-000', 'Rua T', '1110', 'Casa', 'Éden', 'Sorocaba', 'SP');
